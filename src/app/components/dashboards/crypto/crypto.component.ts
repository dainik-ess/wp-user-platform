...
@Component({
  selector: 'app-crypto',
  standalone: true,
  imports: [RouterModule,SharedModule,NgApexchartsModule,NgSelectModule,FormsModule,ReactiveFormsModule,NgbModule],
...
ngOnInit(): void {
  this.simpleItems=['BTC','ETH','XRP','DASH','NEO','LTC','BSD'];
  this.simpleItems1=['AED','ARS','aUD','AZN','BGN','BRL'];
  this.simpleItems2=['BTC','ETH','XRP','DASH','NEO','LTC','BSD'];
  this.simpleItems3=['AED','ARS','aUD','AZN','BGN','BRL'];
